namespace _17.DoWhile
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //17. Algoritmo que solicita un número y genere su correspondiente tabla de multiplicar desde el 1 hasta el ´10. Y asi sucesivamente hasya que el usuario ya no desee continuar generando tablas de multiplicar
